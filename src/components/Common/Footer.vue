    ...
    <div class="page-container">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
        <div class="lg:col-span-1">
          <router-link :to="{ name: 'Home' }" class="block mb-4">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="/hotels/list" class="font-cairo text-sm text-base-content/70 hover:text-primary transition-colors">Hotels</a></li>
            <li><a href="/trips/list" class="font-cairo text-sm text-base-content/70 hover:text-primary transition-colors">Trips</a></li>
            <li><a href="/attractions/list" class="font-cairo text-sm text-base-content/70 hover:text-primary transition-colors">Attractions</a></li>
            <li><a href="/cars/list" class="font-cairo text-sm text-base-content/70 hover:text-primary transition-colors">Cars</a></li>
          </ul>
        </div>
        <div>
